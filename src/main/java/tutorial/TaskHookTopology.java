...
public static void main(String[] args) throws Exception {
 ...
 conf.setNumStmgrs(2);
 HeronSubmitter.submitTopology("TaskHookTopology", conf, builder.createTopology());
}
...
public static class TestTaskHook implements ITaskHook {
 ...
 public TestTaskHook() {
   this.constructString = "coap://californium.eclipse.org:5683/obs";
 }
...
public static class AckingTestWordSpout extends BaseRichSpout {
 ...
 public void open(
   ...
   context.addTaskHook(
       new TestTaskHook("coap://californium.eclipse.org:5683/obs"));
 }

 public void close() {
 }

 //not sure how to invoke this method as this should be exec
 public void nextTuple() {
   ...
   collector.emit(new Values(time),time);
 }
...
public static class CountBolt extends BaseRichBolt {
 ...
 public void prepare(
   ...
   // Add task hook dynamically
   context.addTaskHook(new TestTaskHook("coap://californium.eclipse.org:5683/obs"));
